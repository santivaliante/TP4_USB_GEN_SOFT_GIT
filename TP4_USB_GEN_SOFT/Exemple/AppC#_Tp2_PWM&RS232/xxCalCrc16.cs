...
public class CalCrc { 
    // SL125_ELNU et SL229_MINF
    // Fonction pour calcul d'un CRC16-CCITT
    // Adaptation VB 2005 6.04.2008
    // Table calcul CRC16 (Polynome 0x1021)
    // Modification formule 20.02.2015 C. HUBRE

      short[] CRC16_table = {
       0x0, 0x1021, 0x2042, 0x3063, 0x4084, 0x50A5, 0x60C6, 0x70E7,
       33032, 37161, 0xA14A, 0xB16B, 0xC18C, 0xD1AD, 0xE1CE, 0xF1EF,
    ...
    public short updateCRC16(short crc, byte data) {
        // retourne la nouvelle valeur du crc  NOUVELLE FORMULE
        return (CRC16_table[((crc >> 8) & 0xFF) ^ data] ^ (crc << 8);
    }
    /*
    Public Function updateCRC16_old(ByVal crc As UShort, ByVal data As Byte) As UShort

        ' retourne la nouvelle valeur du crc 
        Return (CRC16_table((crc >> 8) And 0xFF) Xor (crc << 8) Xor data)
    End Function
    */
}